...
1. Basic boilerplate code. Then went on to the whiteboard ![](./01.jpg)
1. Then I realised that my idea of thinking about cycles was wrong when it came to mapping the positive and negative phase![](./02.jpg)
1. A big realisation: I forgot to include the frequency of the wave. Once I added that, the next thing left to do was to try to come up with a formula for phase_increment in relation to frequency![](./03.jpg)
